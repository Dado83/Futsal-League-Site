...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying1->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying2->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying3->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying4->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying5->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying6->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying7->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying8->team je slobodan</td></tr>"
    ?>
</table>
<br>
<table class="pairs">
...
EOT;
    ...
    echo "<tr><td colspan=3>$notPlaying9->team je slobodan</td></tr>"
    ?>
</table>
<br>
