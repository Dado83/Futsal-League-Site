...
<div class="finalFourRes">
    <h1 style="text-align:center">Završni turnir</h1>
    <div class="generation">
        <div class="semis">
            <h3>2010. godište polufinale</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
...
EOT;
        ...
        <div class="semis">
            <h3>2010. godište za 3. mjesto</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
...
EOT;
        ...
        <div class="semis">
            <h3>2009. godište za 3. mjesto</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
...
EOT;
        ...
        <div class="semis">
            <h3>2008. godište za 3. mjesto</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
...
EOT;
        ...
        <div class="semis">
            <h3>2007. godište za 3. mjesto</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
...
EOT;
        ...
        <div class="semis">
            <h3>2006. godište za 3. mjesto</h3>
            <table>
                <?php
                echo <<<EOT
            <tr>
